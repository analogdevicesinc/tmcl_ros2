...
def generate_launch_description():
  ...
  ## Include YAML file
  autogenerated_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'autogenerated', 'TMCM-3212.yaml')
  ext_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'TMCM-3212_Ext.yaml')
  ...
  arg_tmcl_base_name = DeclareLaunchArgument('tmcl_base_name', default_value='tmcm3212')
  ...
  arg_mtr0_pos_x = DeclareLaunchArgument('mtr0_pos_x', default_value='-1.00')
  ...
  arg_mtr1_pos_x = DeclareLaunchArgument('mtr1_pos_x', default_value='0')
  ...
  arg_mtr2_pos_x = DeclareLaunchArgument('mtr2_pos_x', default_value='1.00')
