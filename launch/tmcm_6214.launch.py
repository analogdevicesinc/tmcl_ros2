...
def generate_launch_description():
  ...
  ## Include YAML file
  autogenerated_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'autogenerated', 'TMCM-6214.yaml')
  ext_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'TMCM-6214_Ext.yaml')
  ...
  arg_tmcl_base_name = DeclareLaunchArgument('tmcl_base_name', default_value='tmcm6214')
  ...
  arg_mtr0_pos_x = DeclareLaunchArgument('mtr0_pos_x', default_value='-2.50')
  ...
  # motor1 Arguments
  arg_mtr1_base_name = DeclareLaunchArgument('mtr1_base_name', default_value=[ns_prefix_,'/',tmcl_base_name_,'_mtr1_frame'])
  arg_mtr1_pos_x = DeclareLaunchArgument('mtr1_pos_x', default_value='-1.50')
  arg_mtr1_pos_y = DeclareLaunchArgument('mtr1_pos_y', default_value='1')
  ...
  # motor2 Arguments
  arg_mtr2_base_name = DeclareLaunchArgument('mtr2_base_name', default_value=[ns_prefix_,'/',tmcl_base_name_,'_mtr2_frame'])
  arg_mtr2_pos_x = DeclareLaunchArgument('mtr2_pos_x', default_value='-.50')
  arg_mtr2_pos_y = DeclareLaunchArgument('mtr2_pos_y', default_value='1')
  ...
  # motor3 Arguments
  arg_mtr3_base_name = DeclareLaunchArgument('mtr3_base_name', default_value=[ns_prefix_,'/',tmcl_base_name_,'_mtr3_frame'])
  arg_mtr3_pos_x = DeclareLaunchArgument('mtr3_pos_x', default_value='.50')
  arg_mtr3_pos_y = DeclareLaunchArgument('mtr3_pos_y', default_value='1')
  ...
  # motor4 Arguments
  arg_mtr4_base_name = DeclareLaunchArgument('mtr4_base_name', default_value=[ns_prefix_,'/',tmcl_base_name_,'_mtr4_frame'])
  arg_mtr4_pos_x = DeclareLaunchArgument('mtr4_pos_x', default_value='1.50')
  arg_mtr4_pos_y = DeclareLaunchArgument('mtr4_pos_y', default_value='1')
  ...
  # motor5 Arguments
  arg_mtr5_base_name = DeclareLaunchArgument('mtr5_base_name', default_value=[ns_prefix_,'/',tmcl_base_name_,'_mtr5_frame'])
  arg_mtr5_pos_x = DeclareLaunchArgument('mtr5_pos_x', default_value='2.50')
  arg_mtr5_pos_y = DeclareLaunchArgument('mtr5_pos_y', default_value='1')
